...
namespace ProjectsNetwork.Tests
{
    public class InterestedInProjectRepositoryTest : IDisposable
    {
        ...
        {
            var inserted = this._InterestedInProjectRepository.Insert(new InterestedInProject());
        ...
        {
            var interestedInProjects = _InterestedInProjectRepository.GetAll();
            Assert.NotNull(interestedInProjects);
            Assert.NotEmpty(interestedInProjects.ToList());
        }
